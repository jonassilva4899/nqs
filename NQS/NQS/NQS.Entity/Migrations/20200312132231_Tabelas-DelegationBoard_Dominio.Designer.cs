...
namespace Leega.Entity.Migrations
{
    ...
    [Migration("20200312132231_Tabelas-DelegationBoard_Dominio")]
    partial class TabelasDelegationBoard_Dominio
    {
            ...
            modelBuilder.Entity("Leega.Entity.DelegationBoard", b =>
                {
                    ...
                    b.Property<int>("DelegationPoker")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Leega.Entity.DelegationBoard", b =>
                {
                    b.HasOne("Leega.Entity.Dominio", "Dominio")
                        .WithOne("DelegationBoard")
                        .HasForeignKey("Leega.Entity.DelegationBoard", "IdDominio")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
