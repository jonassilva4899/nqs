...
{
    public class ServicoGenerico<Tv, Te> : IService<Tv, Te> where Tv : BaseDomain
                                      where Te : BaseEntity
    {

        protected IUnitOfWork _unitOfWork;
        protected IMapper _mapper;
        public ServicoGenerico(IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public virtual Tv GetOne(Guid id)
        {
        ...
        public virtual Guid Add(Tv view)
        {
