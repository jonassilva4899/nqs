...
namespace CSharpAwsS3ServiceManager.AwsS3
{
    public interface IAwsS3HelperService
    {
        ...
        Task<bool> UploadExcelFileAsync(Stream fileStream, string fileName, string directory = null);
        Task<bool> UploadArquivoFileAsync(Stream fileStream, string fileName, string contentType, string directory = null);
        Task<bool> UploadFileAsync(string arquivoBase64, string nomeArquivo, string directory = null);
        ...
        Task<(Stream FileStream, string ContentType)> ReadFileAsync(string fileName, string directory = null);
